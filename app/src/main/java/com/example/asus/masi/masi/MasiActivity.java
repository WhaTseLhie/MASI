...
import com.example.asus.masi.AndroidDatabaseManager;
...
import com.example.asus.masi.masi.add.AddProductActivity;
import com.example.asus.masi.sales.SalesReportActivity;
import com.example.asus.masi.view.ViewAccountActivity;
import com.squareup.picasso.Picasso;

public class MasiActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, DialogInterface.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_masi);
        ...
        //Picasso.with(this).load(R.drawable.bro).transform(new CircleTransform()).into(iv);
        txtName.setText("Made By: Jayvee John E. Pardillo");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.masi, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_view) {
            Intent viewIntent = new Intent(this, ViewAccountActivity.class);
            startActivity(viewIntent);
        } else if (id == R.id.nav_sales) {
            Intent salesIntent = new Intent(this, SalesReportActivity.class);
            startActivity(salesIntent);
        } else if (id == R.id.nav_about) {
            Intent aboutIntent = new Intent(this, AboutActivity.class);
            aboutIntent.putExtra("type", "admin");
            startActivity(aboutIntent);
        } else if(id == R.id.nav_db) {
            Intent dbIntent = new Intent(this, AndroidDatabaseManager.class);
